...
export const Vortex = (props) => {
  ...
  const initParticle = (i) => {
    ...
    x = rand(canvas.width); // Random x across the canvas width
    y = rand(canvas.height); // Random y across the full canvas height
    vx = 0;
    vy = 0;
    life = 0;
  ...
  const resizeCanvas = (canvas, ctx) => {
    ...
    canvas.height = Math.max(innerHeight, document.documentElement.scrollHeight);
